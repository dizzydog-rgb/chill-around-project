import"./all-B7fgtTnm.js";import"./main-8UblBU7c.js";import{a as d}from"./axios-CCb-kr4I.js";$(document).ready(function(){const s=localStorage.getItem("token"),b=localStorage.getItem("emailid");if(!s){alert("請先登入"),window.location.href="index.html";return}console.log("用戶 ID:",b),d.get("http://localhost:8080/member/members",{headers:{Authorization:`Bearer ${s}`}}).then(c=>{const e=c.data;let u=new Date(e.birthday).toLocaleDateString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit"}).replace(/\//g,"-");var f=`
