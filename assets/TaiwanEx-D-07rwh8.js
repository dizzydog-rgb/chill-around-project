import"./all-DcTbhZgf.js";import"./main-BX2b4uAz.js";$(document).ready(function(){if(!localStorage.getItem("token")){alert("請先登入"),window.location.href="index.html";return}var x=`
    <div class="Taiwanmap">
    ...
    `;$(".TaiwanEx").html(x),$("#logoutbtn").click(function(){confirm("您確定要登出嗎？")&&(localStorage.removeItem("token"),window.location.href="index.html")}),function(){b();var v=["#fff","#27BBEE","#88B14B","#F5A623","#FF7A7A"],l=[{id:"新北",lv:0},{id:"台北",lv:0},{id:"基隆",lv:0},{id:"桃園",lv:0},{id:"新竹",lv:0},{id:"苗栗",lv:0},{id:"台中",lv:0},{id:"彰化",lv:0},{id:"雲林",lv:0},{id:"嘉義",lv:0},{id:"南投",lv:0},{id:"台南",lv:0},{id:"高雄",lv:0},{id:"屏東",lv:0},{id:"台東",lv:0},{id:"花蓮",lv:0},{id:"宜蘭",lv:0},{id:"馬祖",lv:0},{id:"金門",lv:0},{id:"澎湖",lv:0}],i=document.querySelector("#contextMenu"),g=document.querySelector("#menuTitle"),o="",r=0,y=[].map.call(document.querySelectorAll("text.city"),function(t){return t});y.map(function(t){t.style.cursor="pointer",t.addEventListener("click",m)}),l.map(function(t){var c=[].map.call(document.querySelectorAll("[id^="+t.id+"]"),function(s){return s});c.map(function(s){s.style.fill="#fff",s.style.cursor="pointer",s.addEventListener("click",m)})}),document.addEventListener("mouseup",p),document.addEventListener("touchend",p);function p(t){(!i===t.target||!i.contains(t.target))&&(i.style.display="none")}var h=[].map.call(document.querySelectorAll("div[id^='lv']"),function(t){return t});h.map(function(t){t.addEventListener("click",function(c){var s=parseInt(c.currentTarget.id.replace("lv",""),10);l=l.map(function(e){return e.id===o?Object.assign({},e,{lv:s}):e}),i.style.display="none",w(s),F()})}),document.querySelector("#saveAs").addEventListener("click",function(){var t=new XMLSerializer().serializeToString(document.querySelector("#map")),c=document.createElement("canvas");c.getContext("2d"),c.width=750,c.height=1124,canvg(c,t),c.toBlob(function(s){saveAs(s,"taiwan.png")})});function m(t){const c=window.innerWidth-t.pageX-180-20,s=window.innerHeight-t.pageY-165-30,e=c>0?t.pageX:t.pageX+c,n=s>0?t.pageY:t.pageY+s;i.style.top=n+"px",i.style.left=e+"px",i.style.display="block",o=(t.target.id||t.target.textContent).replace(/\d*/g,""),g.textContent=o}function F(){r=0,l.map(function(t){r+=t.lv}),document.querySelector("#total").textContent=r}function w(t){var c=[].map.call(document.querySelectorAll("[id^="+o+"]"),function(s){return s});c.map(function(s){s.style.fill=v[t]})}function k(t,c){if(t==null)throw new TypeError("Cannot convert first argument to object");for(var s=Object(t),e=1;e<arguments.length;e++){var n=arguments[e];if(n!=null)for(var u=Object.keys(Object(n)),a=0,B=u.length;a<B;a++){var d=u[a],f=Object.getOwnPropertyDescriptor(n,d);f!==void 0&&f.enumerable&&(s[d]=n[d])}}return s}function b(){Object.assign||Object.defineProperty(Object,"assign",{enumerable:!1,configurable:!0,writable:!0,value:k})}}()});
